...
var Shape = (function () {
    ...
    function Shape() {
        ...
        this._position = new _Point.ExtendedPoint(position);
    ...
    _createClass(Shape, [{
        ...
        value: function getMatrix() {
            //todo cache matrix?
            var rotation = new _Matrix.Matrix({
            ...
            var translation = new _Matrix.Matrix({
        ...
        value: function _intersectCircleCircle(c1, r1, c2, r2) {
            ...
            if (c_dist > r_max) {
                ...
                points.push(new _Point.ExtendedPoint(p.x - b * (c2.y - c1.y), p.y + b * (c2.x - c1.x)));
